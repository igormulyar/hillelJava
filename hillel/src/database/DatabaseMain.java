...
public class DatabaseMain {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Optional<Product> possibleProduct = findById(connection, 2);
    ...
    private static Optional<Product> findById(Connection connection, int id) throws SQLException {                         // FEATURE -  Optional<T>
